...
function EUF = CalculateExpectedUtilityFactor( I )
  ...
  % YOUR CODE HERE...
  %
  V = unique([I.RandomFactors(:).var]);
  elim = setdiff(V ,I.DecisionFactors.var)
  factors = VariableElimination([I.RandomFactors,I.UtilityFactors],elim)
  EUF = factors(1)
  for i = 2:length(factors)
    EUF = FactorProduct(EUF,factors(i))
  end 
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
