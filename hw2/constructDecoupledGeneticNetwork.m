...
for i=1:numPeople
	...
	if(parentOne == 0 && parentTwo == 0)
		...
		factorList(i) = childCopyGivenParentalsFactor(numAlleles, i, parentOne, parentOne + numPeople)
		factorList(i + numPeople) = childCopyGivenParentalsFactor(numAlleles, i + numPeople, parentTwo, parentTwo + numPeople)
	end
